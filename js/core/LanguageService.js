...
export const LanguageService = {
    ...
    dictionary: {
        es: {
            ...
            "home.settings": "Ajustes Globales", // NUEVO
            "home.changelog": "Historial",
            "home.roadmap": "Futuro",
            
            // Global Settings
            "settings.global.title": "Configuración de la Aplicación",
            "settings.api.key": "OpenAI API Key",
            "settings.calendar": "Sistema de Calendario",
            "settings.cal.gregorian": "Gregoriano (Tierra)",
            "settings.cal.harptos": "Harptos (Reinos Olvidados)",
            "settings.cal.imperial": "Calendario Imperial",
            "settings.custom.assets": "Estilos Personalizados",
            "settings.upload.paper": "Subir Textura Papel",
            "settings.upload.font": "Subir Fuente (.ttf/.woff)",
            "btn.save.global": "Guardar Configuración Global",

            // Newspaper AI & Obituaries
            "news.ai.prompt": "Describir el suceso para la IA...",
            "news.btn.generate": "✨ Generar con IA",
            "news.btn.obituary": "⚰️ Generar Esquela",
            
            // ... (Resto de traducciones previas) ...
        ...
        en: {
            ...
            "home.settings": "Global Settings", // NUEVO
            "home.changelog": "History",
            "home.roadmap": "Roadmap",
            
            "settings.global.title": "Application Configuration",
            "settings.api.key": "OpenAI API Key",
            "settings.calendar": "Calendar System",
            "settings.cal.gregorian": "Gregorian (Earth)",
            "settings.cal.harptos": "Harptos (Forgotten Realms)",
            "settings.cal.imperial": "Imperial Calendar",
            "settings.custom.assets": "Custom Styles",
            "settings.upload.paper": "Upload Paper Texture",
            "settings.upload.font": "Upload Font (.ttf/.woff)",
            "btn.save.global": "Save Global Settings",

            "news.ai.prompt": "Describe event for AI...",
            "news.btn.generate": "✨ Generate with AI",
            "news.btn.obituary": "⚰️ Generate Obituary",
