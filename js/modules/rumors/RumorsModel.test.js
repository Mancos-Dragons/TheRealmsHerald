...
test('RumorsModel - fallback to procedural generation when AIService is not configured', async (t) => {
    ...
    // Assert that the procedural output correctly incorporates all the passed-in variables
    ...
    // Assert that hook property is non-empty string
    assert.strictEqual(typeof result.hook, 'string', 'Hook should be a string');
