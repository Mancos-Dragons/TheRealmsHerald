...
test('RumorsModel - fallback to procedural generation when AIService is not configured', async (t) => {
    ...
    // Assert that the generated string strictly contains the passed arguments
    ...
    // Assert that the generated hook is one of the procedural plot hooks
...
test('RumorsModel - uses defaults when arguments are empty', async (t) => {
    ...
    assert.ok(
        ...
        'Rumor should use the default variables'
    );
