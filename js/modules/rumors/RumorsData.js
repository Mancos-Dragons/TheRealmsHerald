export const defaultTown = { es: "Pueblo Viejo", en: "Old Town" };
export const defaultNpcName = { es: "Desconocido", en: "Unknown" };
export const defaultNpcRole = { es: "Viajero", en: "Traveler" };
