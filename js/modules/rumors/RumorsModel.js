        ...
        this.grammar = {
            es: {
                intros: [
                    ...
                    "Un mercader forastero llegó preguntando y dijo que",
                    "Nadie confía en él, se rumorea que",
                    "En la taberna se susurra que",
                    "Los viajeros que pasan afirman que"
                ],
                subjects: [
                    "{npcName}, nuestro {npcRole},",
                    "el {npcRole} conocido como {npcName}",
                    "aquel {npcRole} llamado {npcName}",
                    "{npcName} (quien se hace llamar {npcRole})"
                ],
                actions: [
                ...
                locations: [
                    ...
                    "a las afueras de {townName} a medianoche.",
                    "en el cementerio abandonado de {townName}.",
                    "en las alcantarillas bajo {townName}.",
                    "en la plaza del mercado de {townName} cuando nadie miraba."
                ],
                hooks: [
            ...
            en: {
                intros: [
                    ...
                    "Some whisper that",
                    "Rumor has it that",
                    "A foreign merchant arrived asking and said that",
                    "Nobody trusts them, it is rumored that",
                    "In the tavern it's whispered that",
                    "Travelers passing through claim that"
                ],
                subjects: [
                    "{npcName}, our {npcRole},",
                    "the {npcRole} known as {npcName}",
                    "that {npcRole} called {npcName}",
                    "{npcName} (who calls themselves a {npcRole})"
                ],
                actions: [
                ...
                locations: [
                    ...
                    "on the outskirts of {townName} at midnight.",
                    "in the abandoned graveyard of {townName}.",
                    "in the sewers beneath {townName}.",
                    "in the market square of {townName} when nobody was looking."
                ],
                hooks: [
