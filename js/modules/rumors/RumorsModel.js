...
import { defaultTown, defaultNpcName, defaultNpcRole, RUMOR_TEMPLATES, PLOT_HOOKS } from './RumorsData.js';

export default class RumorsModel {
    constructor() {
        this.defaultTown = defaultTown;
        this.defaultNpcName = defaultNpcName;
        this.defaultNpcRole = defaultNpcRole;
