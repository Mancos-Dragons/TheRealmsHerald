        ...
        this.grammar = {
            es: {
                intros: [
                    ...
                    "Hay rumores de que",
                    "Nadie confía cuando dicen que",
                    "Se rumorea que"
                ],
                subjects: [
                    "{npcName}, el {npcRole} de {townName},",
                    "{npcName} (nuestro {npcRole} en {townName}),",
                    "{npcName}, el infame {npcRole} de {townName},"
                ],
                actions: [
            ...
            en: {
                ...
                subjects: [
                    ...
                    "{npcName} (our local {npcRole} in {townName}),",
                    "{npcName}, the infamous {npcRole} of {townName},"
                ],
                actions: [
                    "was seen making shady deals",
                    "knows where the lost treasure is hidden",
                    "is summoning forces beyond their control",
                    "is actually a spy for a rival kingdom",
                    "has been brewing poisons for an assassin",
