...
export default class RumorsModel {
        ...
        this.grammar = {
            es: {
                intros: [
                    ...
                    "Los niños del lugar cantan que",
                    "Un viajero solitario afirma que"
                ],
                subjects: [
                    "{npcName}, el {npcRole} de {townName},",
                    "aquel llamado {npcName}, que trabaja como {npcRole} en {townName},",
                ...
                locations: [
                    ...
                    "en su propia casa a escondidas.",
            ...
            en: {
                intros: [
                    ...
                    "The local children sing that",
                    "A lone traveler claims that"
                ],
                subjects: [
                    "{npcName}, the {npcRole} from {townName},",
                    "the one named {npcName}, who works as {npcRole} in {townName},",
    ...
    async generateRumor(townName, npcName, npcRole) {
        ...
        const grammarObj = this.grammar[lang] || this.grammar['es'];

        const pick = (arr) => arr[Math.floor(Math.random() * arr.length)];
        const intro = pick(grammarObj.intros);
        const subject = pick(grammarObj.subjects);
        const action = pick(grammarObj.actions);
        const location = pick(grammarObj.locations);
        const hookText = pick(grammarObj.hooks);
